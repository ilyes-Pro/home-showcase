    ...
    return (
        ...
        <div className='dark:bg-black'>
            <div className="w-11/12  mx-auto px-4 " ref={ref}>
                ...
                >
                    <h1 className='text-center pt-5 text-3xl mb-1.5'>
                        <span className="font-bold dark:text-white">About </span>
                        <span className="underline dark:text-white">Our Brand</span>
                    </h1>
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-17 pb-8" >
                    ...
                    >
                        ...
                        <div className='flex gap-15 mb-6'>
                            <div>
                                <span className='font-medium text-4xl dark:text-white'>10+</span>
                                <h6 className='text-[var(--color-secand)]'>Years of Excellence</h6>
                            </div>
                            <div>
                                <span className='font-medium text-4xl dark:text-white'>12+</span>
                                <h6 className='text-[var(--color-secand)]'>Years of Excellence</h6>
                            </div>
                        </div>
                        ...
                        <div className='flex gap-15 mb-6'>
                            <div>
                                <span className='font-medium text-4xl dark:text-white'>20+</span>
                                <h6 className='text-[var(--color-secand)]'>Years of Excellence</h6>
                            </div>
                            <div>
                                <span className='font-medium text-4xl dark:text-white'>25+</span>
                                <h6 className='text-[var(--color-secand)]'>Years of Excellence</h6>
                            </div>
                        </div>
